...
''')
    ...
    # ==========================================
        ...
        log_text("GIVING ME PERMISSION TO USE HER OUT OF TUNE COVERS", "CYAN")
        log_text("AND I'D ALSO LIKE TO THANK DISCORD USER:@laserpointer2529", "CYAN")
        log_text("FOR HELPING OUT AS A BETA TESTER FOR ERRORS SO I COULD SAVE", "CYAN")
        log_text("TIME AND IMMEDIANTLY GO TO WHERE THE ERROR WAS INSTEAD OF HAVING", "CYAN")
        log_text("TO GO THROUGH THE PAINFUL PROCESS OF CLICKING THE START AND STOP", "CYAN")
        log_text("BUTTON EVERY SINGLE TIME JUST TO FIND ONE LINE OF CODE ERROR!", "CYAN")
        log_text("I'D ALSO LIKE TO THANK THE USER FOR TAKING TIME INTO PLAYING MY GAME!", "CYAN")
        log_text("I WOULD ALSO LIKE TO CREDIT THE AUTHOR OF 'How to Survive Your Murder'", "CYAN")
        log_text("(Danielle Rollins) BECAUSE MOST OF THE STORY LINE CAME FROM PARTS OF THE BOOK", "CYAN")
        log_text("AND THE DEVELOPERS OF POPPY PLAYTIME HAVE MY THANKS FOR THE IDEA OF THE", "CYAN")
        log_text(" 'MOTIVATION' DIALOGE FOR WHEN THE PLAYER DIES!", "CYAN")
        log_text("I HOPE YOU HAVE A GREAT DAY! FAREWELL!", "CYAN")
        log_text("")
        log_text("")
        log_text("USER PLEASE SCROLL TO TOP TO READ EVERYTHING!")
